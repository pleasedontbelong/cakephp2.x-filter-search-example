...
/**
 * index method with HABTM example
 *
 * @return void
 */
	public function index_habtm() {
					...
					if($name == "search"){
						...
						$joins = array(
							array(
			                  ...
			                  'alias' => 'ActorsMovie',
			                  'type' => 'INNER',
			                  'conditions' => array('ActorsMovie.movie_id = Movie.id')
			                )
						);
						$conditions['ActorsMovie.actor_id'] = $value;
					} else {
						$conditions[$name] = $value;
					}					
					$this->request->data['Filter'][$name] = $value;	
		...
		$this->set(compact('genres', 'directors','actors'));
